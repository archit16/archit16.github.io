...
<a href="../php/categories.php" style="color:white;font-family: 'Questrial', sans-serif;margin-top:0px;margin-bottom:5px;"><button id="rcorners3" style="color:white;margin-top:20px;">GO BACK</button></a>
<hr>
