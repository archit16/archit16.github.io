...
echo '<h1 align="center" style="font-size: 100px;font-family: Questrial, sans-serif;font-style: normal;font-variant: normal;font-weight: 100;color:black;background-color:'.$color_arr[3].';margin-top:10px;" class="animtrev">';
...
while ($row=mysqli_fetch_row($result)){
    $i=($i+1)%4;
    $j=($j+1)%8;
    echo '<h1 align="center" style="font-size: 60px;font-family: Questrial, sans-serif;font-style: normal;font-variant: normal;font-weight: 100;color:black;background-color:'.$color_arr[3].';margin-top:10px;" class="fadein3">';
    echo $row[3];
    echo '</h1>';
    echo '<div class="fadein2">';
    
    echo '<ul class="ch-grid ar1 fid" style="margin-top:0px;" align="center"><li><div class="ch-item '.$styleimg_arr[$j].' ar1 fid" style="margin-top=0px;"><div class="ch-info1">';
